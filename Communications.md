...
* Path - Приемопередатчик специального назначения может быть сопряжен с двумя физическими каналами или с двумя физическими битовыми кодировками на одном и том же канале. Значение 0 используется для основного канала, а значение 1 используется для альтернативного канала. *Delta Backlog - используется для настройки количества слотов для произвольного доступа. Принимающие устройства добавляют это значение к своей оценке невыполненной работы, чтобы учесть передачу этого  кадра.
